          ...
          <svg id="bongo-cat" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 787.3 433.8">
            <defs>
              ...
              <symbol id="paw-pads" data-name="paw-pads" viewBox="0 0 31.4 33.9">
                <path d="M6.8,16a3.7,3.7,0,0,1,1.1,2.8,3.2,3.2,0,0,1-1.6,2.6L5,21.8H4.4a2.8,2.8,0,0,1-1.8.3A4.2,4.2,0,0,1,.2,19.1,7.7,7.7,0,0,1,0,17.6a2.8,2.8,0,0,1,.6-2,3.2,3.2,0,0,1,2.1-.8H4A5,5,0,0,1,6.8,16Z" fill="#ef97b0"/>
              </symbol>
            </defs>
            ...
            <g id="head">
              ...
              <g id="head__face">
                <g id="eyes">
                  <use xlinkHref="#eye" width="19.2" height="18.7" transform="translate(474.8 195.2)"/>
                  <use xlinkHref="#eye" width="19.2" height="18.7" transform="matrix(-0.51, -0.85, 0.82, -0.5, 370.39, 192.59)"/>
                </g>
            ...
            <g id="table">
              ...
              <g id="laptop">
                ...
                <g id="laptop__keyboard">
                  ...
                  stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2"
                  />
                  ...
                  <polygon
                  points="201.7 273.1 187.7 270.2 196.2 268 210.4 271 210.7 273.1" 
                  stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2"
                  />
                ...
                <g id="paw-right">
                  ...
                  <g id="paw-right--up">
                    ...
                    <use xlinkHref="#paw-pads" width="31.4" height="33.93" transform="translate(273.2 166.1) rotate(-5.6)"/>
                  </g>
                </g>
                ...
                <g id="laptop__cover" style={{ mixBlendMode: 'hard-light' }}>
                  ...
                  <path d="M440.4,346.4c-2.5-5.3-6.5-18.8-9-27.4L390.7,178c-13.6-46.8-26.9-93.7-40.3-140.6l2.3,2L4.4,7.1,7.9,2.8,94,274.5l-2.9-2.6q83.7,16.8,166.8,34.2t166.8,35.4c8.8,1.9,17.5,5.1,14.7,5.5s-6.3-.2-12-.9-12.3-1.5-16.8-2.3Q330.5,328.1,250,312.1c-53.5-10.8-107.1-21.7-160.4-32.7l-2.3-.5-.6-2.1L1.5,4.8,0,0,5,.5,353.3,34l1.8.2.5,1.8q20.7,73.8,41.2,147.8l40.6,147.5C439.8,340.1,442.9,351.7,440.4,346.4Z" fill="#000" />
                </g>

                <g id="laptop__terminal_code_scene">
                  <g id="laptop__code">
                    <TypingAnimation id="f3-l9" pathData="M8,25L8,25" dashArray="60,10" />
                    <TypingAnimation id="f3-l8" pathData="M8,13L8,13" dashArray="50,10" />
                    <TypingAnimation id="f3-l7" pathData="M0,1L0,1" dashArray="25,10" />
                    <TypingAnimation id="f2-l6" pathData="M8,25L8,25" dashArray="40,10" />
                    <TypingAnimation id="f2-l5" pathData="M8,13L8,13" dashArray="60,10" />
                    <TypingAnimation id="f2-l4" pathData="M0,1L0,1" dashArray="30,10" />
                    <TypingAnimation id="f1-l3" pathData="M8,25L8,25" dashArray="60,10" />
                    <TypingAnimation id="f1-l2" pathData="M8,13L8,13" dashArray="60,10" />
                    <TypingAnimation id="f1-l1" pathData="M0,1L0,1" dashArray="60,10" />
                  </g>
                </g>
              </g>
